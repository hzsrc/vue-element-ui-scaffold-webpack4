<template>
    <div class="pd-10 theme-cl">
        <div>
            <span class="v-top" style="line-height: 30px"
            >Change theme color to:
            </span>
            <change-color></change-color>
            <el-button @click="reset" size="small" style="float: right"
            >Reset
            </el-button
            >
        </div>
        ...
        <el-button plain type="primary" icon="el-icon-picture"
        >primary
        </el-button
        >
        ...
        <div class="custom-color">my custom color</div>
        <div class="custom-color2">my custom color 2</div>
