<template>
    <div class="pd-10 main-page">
        ...
        <div style="padding: 20px 0">
            ...
            >
            <el-button @click="callLoading" size="small" type="primary"
            >call base api
            </el-button
            >
            <el-button @click="callUnmockedApi" size="small"
            >call base api(not mocked)
            </el-button
            >
            <el-button @click="callOtherApi" size="small"
            >call other api servers by {xxx} prefix
            </el-button
            >
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            callLoading() {
                ...
                this.$x.post('/api/test_data', pars).then((res) => {
            ...
            callUnmockedApi() {
                this.$x
                    .post(
                        '/api/get_data',
                        {},
                        { showError: false, maskOptions: { target: '.main-page' } }
                    )
                    .then((res) => {
                    })
                    .catch((e) => {
                        this.$x.toast.error(
                            '接口 http://aaa.bbb.com/api/get_data 访问失败，且未设置mock数据'
                        );
                    });
            },
            callOtherApi() {
                this.$x
                    .post('{node_api}/api/get_xxx', {}, { showError: 'alert' })
                    .then((res) => {
                    });
            },
            getAndGo() {
